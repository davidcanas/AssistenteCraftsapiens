...
class nationinfo extends Command_1.default {
    constructor(client) {
        super(client, {
            name: "nationinfo",
    ...
    async runAutoComplete(interaction, value) {
        try {
            ...
            const similarNations = allNations.data.nations.filter(nation => this.client.utils.levDistance(nation.name.toLowerCase(), value.toLowerCase()) <= 2 ||
